...
var ColorPicker = _react2.default.memo(function (props) {
    var defaultValue = props.defaultValue,
        ...
        _onChangeComplete = props.onChangeComplete;
        ...
        visible && _react2.default.createElement(
            ...
            _react2.default.createElement(_reactColor.ChromePicker, {
                ...
                onChange: function onChange(current, e) {
                    ...
                    _onChange && _onChange(current, e);
                },
                onChangeComplete: function onChangeComplete(current, e) {
                    updateColor(current.hex);
                    _onChangeComplete && _onChangeComplete(current, e);
                }
            })
        )
    );
